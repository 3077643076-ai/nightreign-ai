"""BC 训练入口 — 帧堆叠版：堆叠连续帧 → 手柄按键 + 摇杆。

用法：
    python -m train.train_stacked
"""
...
def train():
    ...
    train_ds = StackedDataset(train_seqs, augment=True)
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        for step, (img, btns, axes) in enumerate(train_loader):
            ...
            with autocast("cuda", enabled=AMP_ENABLED):
                ...
                loss = (l_btn + l_axis) / GRADIENT_ACCUM_STEPS
    ...
    log_path = OUTPUT_DIR / f"train_stacked_log_{ts}.json"
